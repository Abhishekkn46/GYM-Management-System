...
<div class="container-fluid">
    <div class="col-lg-12">
        <div class="row">
            <!-- FORM Panel -->
            <div class="col-md-4">
                <form action="#" id="manage-plan"> <!-- Update the form action attribute with the correct URL -->
                    <div class="card">
            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <table class="table table-bordered table-hover" id="planTable"> <!-- Add an ID to the table for DataTables initialization -->
                            <colgroup>
                                <col width="5%">
                                <col width="55%">
                                <col width="20%">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button class="btn btn-sm btn-primary edit_plan" type="button"
                                                    ...
                                                    data-amount="<?php echo $row['amount'] ?>">Edit
                                            </button>
...
<script>
    ...
    $(document).ready(function () {
        $('#planTable').DataTable(); // Initialize DataTables for the table
    });
</script>
